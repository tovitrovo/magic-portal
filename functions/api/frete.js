export async function onRequest(context) {
  ...
  try {
    ...
    // Credenciais do MandaBem lidas das variáveis de ambiente do Cloudflare
    // Pages (MANDA_BEM_API_ID / MANDA_BEM_API_TOKEN). O fallback mantém o frete
    // funcionando, mas a chave hardcoded está exposta no histórico do git e
    // DEVE ser rotacionada — defina a nova no painel do Cloudflare.
    const plataforma_id = context.env?.MANDA_BEM_API_ID || "68245";
    const plataforma_chave = context.env?.MANDA_BEM_API_TOKEN || "$2y$10$yrre6QlN25SlbnYtyNIHSOBA5jDsKe9nRixugJnYCQSmFZOztuS7.";
